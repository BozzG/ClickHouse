...
/// Implement some methods of ThreadStatus and CurrentThread here to avoid extra dependencies in clickhouse_common_io
namespace DB
{
...
void ThreadStatus::initializeQuery()
{
    ...
    current_thread_scope.deleter = defaultThreadDeleter;
}
